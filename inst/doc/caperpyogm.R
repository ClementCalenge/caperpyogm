...
dataf <- data.frame(
    ...
    Type=c("D",
           ...
           "P",
           "P"),
    Description=c("Number of detected males during census $k$ of the year $t$ on lek $i$",
                  ...
                  "Intercept of the model for the process of detection of males during censuses",
                  "Slope of the number of observers in the model for the detection process of males during censuses",
                  "Number of observers participating to the census $k$ of the year $t$ on lek $i$",
                  "Random effect of the year $t$ on the detectability of males in geographic region $g$",
                  "Standard deviation of the year random effect on the detectability of males during censuses",
                  ...
                  "Proportion of the cell $q$ covered by the potential presence area of the capercaillie",
